    ...
    return function (e) {
        ...
        e.exports = function (e, n, i, f, d, v, g) {
            ...
            var m, w, M, b = function (e) {
                ...
                }, _ = n + " Iterator", A = "values" == d, k = !1, z = e.prototype,
                S = z[x] || z["@@iterator"] || d && z[d], H = !s && S || b(d), V = d ? A ? b("entries") : H : void 0,
            ...
            if (O && (M = h(O.call(new e))) !== Object.prototype && M.next && (p(M, _, !0), t || a(M, x) || o(M, x, u)), A && S && "values" !== S.name && (k = !0, H = function () {
                return S.call(this)
            }), t && !g || !s && !k && z[x] || o(z, x, H), c[n] = H, c[_] = u, d) if (m = {
                values: A ? H : b("values"),
                keys: v ? H : b("keys"),
                entries: V
            }, g) for (w in m) w in z || r(z, w, m[w]); else l(l.P + l.F * (s || k), n, m);
            return m
        }
    }, function (e, n, i) {
        var t = i(55), l = i(37);
...
*/
        ...
        for (var t = i(69), l = i(21), r = i(10), o = i(1), a = i(8), c = i(13), y = i(0), p = y("iterator"), h = y("toStringTag"), x = c.Array, s = {
            ...
            var d, v = u[f], g = s[v], m = o[v], w = m && m.prototype;
        ...
        e.exports = function (e, n, i, f, d, v) {
            var g = t[e], m = g, w = d ? "set" : "add", M = m && m.prototype, b = {}, _ = function (e) {
                var n = M[e];
            ...
            if ("function" == typeof m && (v || M.forEach && !h(function () {
                ...
                var A = new m, k = A[w](v ? {} : -0, 1) != A, z = h(function () {
                    A.has(1)
                }), S = x(function (e) {
                    new m(e)
                }), H = !v && h(function () {
